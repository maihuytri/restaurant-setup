...
public class MenuItemService {
    ...
    public MenuItemResponse createMenuItem(MenuItemRequest menuItemRequest) {
        ...
        menuItem.setStatus(menuItemRequest.stock() <= 0 ? MenuItemStatus.UNAVAILABLE.name() : MenuItemStatus.AVAILABLE.name());
    ...
    public MenuItemResponse updateMenuItem(Long id, MenuItemRequest menuItemRequest) {
        ...
        existingMenuItem.setStatus(menuItemRequest.stock() <= 0 ? MenuItemStatus.UNAVAILABLE.name() : MenuItemStatus.AVAILABLE.name());
